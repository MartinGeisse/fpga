...
import name.martingeisse.picoblaze.simulation.port.IPicoblazePortHandler;
 ...
 */
public final class EncodedInstructionPicoblazeSimulator {
	 ...
	 * Constructor.
	 */
	public EncodedInstructionPicoblazeSimulator() {
	 ...
	 */
	public void setInstructionMemoryFromPsmBinFile(final File file) throws IOException {
